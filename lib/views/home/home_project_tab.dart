...
class TreePlantationScreenTab extends StatefulWidget {
  ...
  TreePlantationScreenTab({
    Key? key,
  }) : super(key: key);

  @override
  _TreePlantationScreenTabState createState() => _TreePlantationScreenTabState();
}

class _TreePlantationScreenTabState extends State<TreePlantationScreenTab> {
        ...
        child: Column(
          children: <Widget>[
            ...
            Expanded(
              ...
              children: [
                SingleHomeProjectCardWidget(
                    title: "Foundation Day Tree Plantation Drives",
                    description:
                        "To kickstart LDCE's Platinum Jubilee Celebrations , we are planning two Tree plantation drives on our upcoming foundati",
                    date: "",
                    onTap: () {
                      if (ModalRoute.of(context)!.settings.name != 'tree_plantation') {
                        ...
                        // );
                        Navigator.of(context)
                            .pushNamedAndRemoveUntil('tree_plantation', ModalRoute.withName('home'));
                      }
                    }),
                SingleHomeProjectCardWidget(
                    title: "AT Hackathon",
